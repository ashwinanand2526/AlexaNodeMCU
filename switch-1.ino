...
void turnOn(String deviceId) {
  if (deviceId == "5f12d6efad7a48327f36daa8") // Device ID of first device
  {  
    Serial.print("Turn on [COKE], Device id: ");
  ...
  else if (deviceId == "5f12cf22ad7a48327f36d9e0") // Device ID of second device
  { 
    Serial.print("Turn on [LAYS], Device id: ");
    Serial.println(deviceId);
    for (int i=1; i<5; i++){
...
void turnOff(String deviceId) {
   if (deviceId == "5f12d6efad7a48327f36daa8") // Device ID of first device
   {  
     Serial.print("Turn off [COKE], Device ID: ");
     Serial.println(deviceId);  
     digitalWrite (ledr1,LOW);   
   }
   else if (deviceId == "5f12cf22ad7a48327f36d9e0") // Device ID of second device
   { 
     Serial.print("Turn off [LAYS], Device ID: ");
     Serial.println(deviceId);
     digitalWrite (ledr2,LOW);
  }
  else {
